...
Процедура СформироватьДвижения()
	...
	Для Каждого Строка Из Сотрудники Цикл
		...
		ДвижениеУдержание.Начисление = Перечисления.ВКМ_СпособРасчета.Премия;
...
Процедура РассчитатьУдержание()
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ИЗ
	               |	РегистрРасчета.ВКМ_Удержания.БазаВКМ_ДополнительныеНачисления(&Измерения, &Измерения, &Разрезы, Регистратор = &Регистратор) КАК ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления
	               |ГДЕ
	               |	ВКМ_УдержанияБазаВКМ_ДополнительныеНачисления.РегистраторРазрез = &Регистратор";
