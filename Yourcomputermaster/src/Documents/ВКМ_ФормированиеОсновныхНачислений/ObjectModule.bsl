...
Процедура РассчитатьУдержания()
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ВКМ_УдержанияБазаВКМ_ОсновоныеНачисления.СуммаБаза КАК СуммаБаза
	               |ИЗ
	               |	РегистрРасчета.ВКМ_Удержания.БазаВКМ_ОсновоныеНачисления(&Измерения, &Измерения, &Разрезы, Регистратор = &Регистратор) КАК ВКМ_УдержанияБазаВКМ_ОсновоныеНачисления
	               |ГДЕ
